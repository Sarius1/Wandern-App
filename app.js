...
function openAddTripModal() {
  openModal(`
    ...
    <div class="field">
      ...
      <input id="m-trip-name" type="text" placeholder="e.g. Allgäu Summer 2025" maxlength="60">
    </div>
    <div class="field">
      <label>Destination</label>
      <input id="m-trip-dest" type="text" placeholder="e.g. Allgäu, Bavaria" maxlength="60">
    </div>
    <div class="field">
  ...
  root.innerHTML = `
    ...
    <div class="map-toolbar">
      <button class="map-btn" id="btn-gpx">
        ${icons.gpx}<span>Load GPX</span>
      </button>
      <button class="map-btn" id="btn-locate">
        ${icons.locate}<span>My Location</span>
      </button>
      ${trip.gpx ? `<button class="map-btn" id="btn-clear-gpx">${icons.trash}<span>Clear Route</span></button>` : ''}
    </div>
